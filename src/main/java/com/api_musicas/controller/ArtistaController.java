...
public class ArtistaController {
    ...
    public ResponseEntity<String> salvarArtista(@PathVariable Long id, @RequestPart("imagem") MultipartFile imagem) throws IOException {

        return ResponseEntity.ok(service.saveImagem(id, imagem));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ArtistaModel> getImagem(@PathVariable Long id) {
    ...
    public ResponseEntity<String> update(@PathVariable Long id, @RequestBody ArtistaDTO dto){
